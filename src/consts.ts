...
export const SITE_METADATA = {
    title: 'Derek M, Blog',
    headerTitle: 'derekm.dev',
    description: 'A site intended to share my personal projects, interests, thoughts, and writings.',
    language: 'en-us',
    theme: 'dark', // Options: system, light, dark, Does not work yet
    siteUrl: 'https://astro-starter-blog.yon.fun/',
    siteRepo: 'https://github.com/wanoo21/tailwind-astro-starting-blog',
    siteLogo: '/static/images/7947o3u3hzea1.png',
    socialBanner: '/static/images/7947o3u3hzea1.png',
    locale: 'en-US',
